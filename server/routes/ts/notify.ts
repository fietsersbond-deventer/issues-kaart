...
emitter.on("issue:created", (issue: Issue & { createdBy: string; createdByUserId: number }) => {
  console.log(
...
emitter.on("issue:modified", (issue: Issue & { modifiedBy: string; modifiedByUserId: number }) => {
  console.log(
...
emitter.on("issue:deleted", (data: { id: number; title: string; deletedBy: string; deletedByUserId: number }) => {
  console.log(
