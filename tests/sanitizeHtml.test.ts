...
describe('HTML Sanitization Security Tests', () => {
  describe('Basic sanitization', () => {
    it('should allow basic HTML tags from Quill editor', () => {
      const input = '<h1>Title</h1><p>Content with <strong>bold</strong> and <em>italic</em> text</p>'
      const result = sanitizeHtml(input)
      expect(result).toBe('<h1>Title</h1><p>Content with <strong>bold</strong> and <em>italic</em> text</p>')
    })
    ...
    it('should allow images with safe attributes', () => {
      const input = '<img src="https://example.com/image.jpg" alt="Description" width="100" height="100">'
      const result = sanitizeHtml(input)
  ...
  describe('XSS Prevention Tests', () => {
    ...
    it('should remove dangerous style attributes', () => {
      const input = '<p style="background-image: url(javascript:alert(\'XSS\'))">Text</p>'
      const result = sanitizeHtml(input)
    ...
    it('should remove form elements', () => {
      const input = '<form><input type="text" name="hack"><button>Submit</button></form>'
      const result = sanitizeHtml(input)
  ...
  describe('Edge Cases', () => {
    ...
    it('should preserve safe HTML entities', () => {
      const input = '<p>&lt;script&gt;alert(&quot;safe&quot;)&lt;/script&gt;</p>'
      const result = sanitizeHtml(input)
